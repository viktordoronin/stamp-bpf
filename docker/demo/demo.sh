...
docker exec stamp_reflector_demo tc qdisc add dev eth0 root netem delay 100ms 20ms distribution normal loss 10%
docker exec stamp_sender_demo tc qdisc add dev eth0 root netem delay 50ms 10ms distribution normal
